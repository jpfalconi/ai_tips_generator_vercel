...
<tr>
  <td style="padding-bottom: 30px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #e5e5e5; border-radius: 8px; background-color: #ffffff;">
       ${section.image ? `
       <tr>
         <td align="center" style="padding: 0; margin: 0; border-top-left-radius: 8px; border-top-right-radius: 8px;">
       ...
       <tr>
         <td style="padding: 30px;">
           ...
           <h2 style="margin: 0 0 15px 0; color: #000000; font-family: Arial, sans-serif; font-size: 26px; font-weight: bold;">${section.title}</h2>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #eeeeee; border-radius: 8px;">
      <tr>
        <td width="70" valign="top" style="padding: 25px 0 25px 25px;">
           <!-- Icon fallback using emoji or simple shape if image fails -->
...
<tr>
  <td style="padding-bottom: 30px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${COLORS.primary}; border-radius: 8px;">
      <tr>
        <td width="70" valign="top" style="padding: 25px 0 25px 25px;">
           <div style="width: 35px; height: 35px; background-color: rgba(255,255,255,0.2); border-radius: 4px; text-align: center; line-height: 35px; color: ${COLORS.secondary}; font-family: Arial, sans-serif; font-size: 20px; font-weight: bold;">
             !
           </div>
        </td>
...
<tr>
  <td style="padding-bottom: 30px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${COLORS.primary}; border-radius: 8px; color: #ffffff; text-align: center;">
      <tr>
...
<tr>
  <td style="padding-bottom: 30px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f9f9f9; border-left: 5px solid ${COLORS.secondary}; border-radius: 0 8px 8px 0;">
      <tr>
...
<tr>
  <td style="padding-bottom: 30px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; border: 1px solid #333333;">
      <tr>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style="background-color: #ffffff; width: 700px; max-width: 700px;">
          ...
          <tr>
            <td align="center" style="padding: 40px 20px 10px 20px;">
               ...
               <h1 style="margin: 0; font-size: 32px; color: #000000; letter-spacing: -1px;">${headerSubtitle}</h1>
            </td>
          </tr>
